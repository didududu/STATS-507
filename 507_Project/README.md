...
Project_Analysis: Analyzing the dataset mertcobanov/animals;
...
Project_CNN: Resnet-18 training classification;

Project_Hugging Face's model: Classification using pre-trained Resnet-50;
